...
<div class="body">
    ...
    <div class="middle_right">
        <div class="middle_right1">
            <form action="/admin/updateArticle?id=<%=request.getParameter("id")%>&thumbNum=<%=request.getParameter("thumbNum")%>&collectNum=<%=request.getParameter("collectNum")%>"
                  method="post">
                <table class="table table-hover" name='user_massage'>
                    ...
                    <tr>
                        <td>
                            <input type="text" name="user_id" value="<%=request.getParameter("user_id")%>"/>
                        </td>
                        <td>
                        ...
                        <td>
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal"
                                    style="font-size:13px " type="button">保存修改
                            </button>
