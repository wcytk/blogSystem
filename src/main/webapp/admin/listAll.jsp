...
<div class="body">
    ...
    <div class="middle_right">
        ...
        <table class="table table-hover" name='user_massage' text-aligin="center">
            ...
            <c:forEach var="user" items="${userlist}">
                ...
                <tr>
                    ...
                    <td><a href="/admin/admin_delete?id=${user.id}">删除</a></td>
                    <td>
                        <a href="../admin/update.jsp?id=${user.id}&username=${user.username}&password=${user.password}&email=${user.email}">修改</a>
                    </td>
                </tr>
                </tbody>
            </c:forEach>
        ...
        <a href="/admin/admin_listAll?page=${page.nextPage}">下一页</a>
        <a href="/admin/admin_listAll?page=${page.prePage}">上一页</a>


    </div>
    <td><a href="../admin/addUser.jsp?id=${user.id}">添加</a></td>
</div>
</body>
</html>
